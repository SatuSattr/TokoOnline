            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-[#212121] border border-gray-800 rounded-xl p-6">
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="mt-4 inline-block text-blue-400 hover:text-blue-300 text-sm">Manage Users</a>
                </div>
                ...
                <div class="bg-[#212121] border border-gray-800 rounded-xl p-6">
                    ...
                    <a href="{{ route('admin.products.index') }}"
                        class="mt-4 inline-block text-green-400 hover:text-green-300 text-sm">Manage Products</a>
                </div>
                ...
                <div class="bg-[#212121] border border-gray-800 rounded-xl p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-lg font-medium text-secondary">Categories</h2>
                            <p class="text-2xl font-bold text-primary">{{ $categoriesCount }}</p>
                        </div>
                    </div>
                    <a href="{{ route('admin.categories.index') }}"
                        class="mt-4 inline-block text-purple-400 hover:text-purple-300 text-sm">Manage Categories</a>
                </div>
                ...
                <div class="bg-[#212121] border border-gray-800 rounded-xl p-6">
                    ...
                    <a href="{{ route('admin.carts.index') }}"
                        class="mt-4 inline-block text-purple-400 hover:text-purple-300 text-sm">Manage Carts</a>
                </div>
            ...
            <div class="bg-[#212121] border border-gray-800 rounded-xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="{{ route('admin.products.create') }}"
                        class="bg-primary text-dark px-6 py-3 rounded-lg hover:bg-gray-200 transition font-medium flex items-center justify-center">

                        ...
                        <tbody class="divide-y divide-gray-800">
                            @foreach ($users as $user)
                                <tr class="hover:bg-dark-light transition">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-primary">{{ $user->id }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-primary">{{ $user->name }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-primary">{{ $user->email }}
                                    </td>
